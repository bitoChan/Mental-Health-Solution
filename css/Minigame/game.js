$(document).ready(function() {
    ...
    if (screenWidth >= 1366) { // For larger screens like 12.9-inch iPad Pro
        minSize = 340;
        maxSize = 320;
    } else if (screenWidth >= 1180 && screenWidth < 1366) { // For medium screens like 11-inch iPad Pro
        minSize = 280;
        maxSize = 260;
    } else if (screenWidth >= 1024 && screenWidth < 1180) { // For smaller screens like iPad Air 2
        minSize = 240;
        maxSize = 220;
    ...
    var runGame = setInterval(function() {
        for (var i = 0; i < 2; i++) { // Simultaneous number of boxes, can modify to control
            dropBox();
        }
    }, 8000); // Interval of game loop, can adjust to modify interval
    ...
    function countdown() {
        ...
        function tick() {
            ...
            if (seconds > 0) {
                ...
                if (score >= 8) {
                    window.location.href = 'Minigame-pass.html'; // Redirect to pass page
                } else {
                    window.location.href = 'Minigame-fail.html'; // Redirect to fail page
                }
            }
        }
        tick();
